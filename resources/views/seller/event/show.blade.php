...
@section('content')
    <section class="section">
            ...
            <div class="col-8">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="row my-2">
                            <div class="col-md-2">
                                <strong class="text-black-50">Nama Kegiatan</strong>
                            </div>
                            <div class="col-md-10">
                                {{$event->name}}
                            </div>
                        ...
                        @if ($event->location)
                            <div class="row">
                                <div class="col-md-2">
                                    <strong class="text-black-50">Lokasi</strong>
                                </div>
                                <div class="col-md-10">
                                    {{$event->location}}
                                </div>
                        ...
                        <div class="row my-2">
                            <div class="col-md-2">
                                <strong class="text-black-50">Dimulai Pada</strong>
                            </div>
                            <div class="col-md-10">
                        ...
                        <div class="row my-2">
                            <div class="col-md-2">
                                <strong class="text-black-50">Diakhiri Pada</strong>
                            </div>
                            <div class="col-md-10">
                                {{ $event->ended_at->format('d F Y H:i') }}
                            </div>
                        </div>
                        <div class="row my-2">
                            <div class="col-md-2">
                    ...
                    <div class="card-footer bg-whitesmoke">
                        <div class="btn-group float-right">
                            ...
                            <a href="{{ route('seller.events.edit', $event->id) }}" class="btn btn-warning">Edit <i class="fa fa-edit"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4>Kehadiran <span class="badge badge-primary">{{$event->attendees->count()}}</span></h4>
                        <div class="card-header-action">
    ...
    <form action="{{route('seller.events.remove_attendee')}}" id="formDeleteAttendee" method="POST">
        @method('DELETE')
        @csrf
        <input type="hidden" name="attendee_id" id="attendee_id">
    </form>

    <form action="{{route('seller.events.destroy', $event->id)}}" id="formDeleteEvent" method="POST">
        @method('DELETE')
        @csrf
    </form>
        ...
        $(function () {
            $('button.btn-delete-event').on('click', function () {
                Swal.fire({
                    ...
                    text: "Anda tidak dapat mengembalikan kegiatan yang dihapus",
                    icon: 'warning',
