                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('seller.products.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="name" name="name" id="name" placeholder="Nama Produk" class="form-control" value="{{ old('name') }}" required>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select name="weight_unit" id="weight_unit" class="form-control">
                                            <option value="kg" selected>Kilo Gram</option>
                                ...
                                <button type="submit" class="btn btn-md btn-primary">Tambah <i class="fa fa-save"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
