...
@section('content')
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data" method="POST">
                                ...
                                <a href="{{route('product.show', [$product->store->slug, $product->slug])}}" role="button" type="button" class="btn btn-md btn-outline-info ml-3">View <i class="fa fa-eye"></i></a>
                                <button role="button" type="button" class="btn btn-md btn-outline-danger btn-delete ml-3">Delete <i class="fa fa-trash"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <form action="{{route('admin.products.destroy', $product->id)}}" method="POST" class="d-none" id="formDelete">
        @csrf
        @method('DELETE')
    </form>
@endsection
